...
7. **Trade niet mogelijk** (Range < `minRangeRR` × R **en/of** R > `maxRTicks` ticks): geen TP-lijn; in plaats daarvan verschijnt een label "Trade niet mogelijk" met per overtreden voorwaarde een eigen regel (gemeten Range in R t.o.v. `minRangeRR`, plus gemeten en benodigde afstand in prijs, bijv. "Range 1.46R < 1.5R (5.57 < 5.70)", en/of gemeten R in ticks + het maximum). De LONG/SHORT-alert wordt in dat geval **niet** onderdrukt — er wordt alleen visueel gesignaleerd dat de trade niet haalbaar is.
