...
| Minimaal benodigde R/R-ruimte in de Range (`minRangeRR`) | 1.5 | De beschikbare ruimte tussen Resistance/Support en de bijbehorende Target-lijn moet minimaal `minRangeRR × R` zijn, anders is de trade "niet mogelijk" (geen TP-lijn, wel een label met de reden). De gemeten Range staat altijd in R in het label: bij een mogelijke trade achter de TP-waarde ("· Range 1.62R"), bij een niet-mogelijke trade in de reden ("Range 1.46R < 1.5R (5.57 < 5.70)"). | De 1.5R is een ruime marge boven de ~1.2R TP, geen harde grens. Omdat R en de S/R-niveaus per broker-feed iets verschillen, kan een grensgeval (bijv. 1.46R) op de ene broker net wel en op de andere net niet slagen — beoordeel zo'n geval zelf aan de hand van de getoonde R-waarde. Is onafhankelijk van de `maxRTicks`-check hieronder; beide voorwaarden kunnen los van elkaar (of tegelijk) een trade blokkeren. |
